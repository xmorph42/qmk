 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |RGBtog| Ins  | Pscr | Menu |      |      |                    |      | PWrd |      | NWrd | DLine| Bspc |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |RGBmod| LGUI | LALT | LCTL |LShift| Caps |-------.    ,-------| Left | Down |  Up  | Right|  Del | PgUp |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT(
  ...
  _RGB_MOD, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT , KC_CAPS,                     KC_LEFT, KC_DOWN,  KC_UP,   KC_RGHT , KC_DEL  , KC_PGUP,
