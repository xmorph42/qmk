...
[_ADJUST] = LAYOUT(
  ...
  _______,   _______,   _______,  _______, _______, _______,                   KC_WH_U, KC_BTN1, KC_BTN3, KC_BTN2, KC_WH_L, _______,
  _______,   _______,   _______,  _______, _______, _______,                   KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______,
  _______,   _______,   _______,  _______, _______, _______, _______, _______, KC_WH_D, KC_MPRV, KC_MPLY, KC_MNXT, KC_WH_R, _______,
#ifdef SOFLE
                        SOFLE_L,  _______, _______, _______, _______, _______, _______, _______, _______, SOFLE_R
#else
                                  _______, _______, _______, _______, _______, _______, _______, _______
